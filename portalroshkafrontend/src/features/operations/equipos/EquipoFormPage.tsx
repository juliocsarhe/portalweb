...
//  Tipo para los usuarios que vienen de /usuarios-disponibles 
...
export default function EquipoFormPage() {
    ...
    // Para cargar usuarios disponibles
            ...
            <div className="relative z-10 flex flex-col h-full p-4">
                <div className="bg-white/60 backdrop-blur-md rounded-2xl shadow-xl p-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {/* NOMBRE */}
                        <div>
                            <label className="block text-sm font-semibold">Nombre del Equipo</label>
                            <input
                                type="text"
                                value={nombre}
                        ...
                        <div>
                            <h3 className="font-semibold mb-2 text-brand-blue">Seleccionar Miembros</h3>
                                    ...
                                    <thead className="bg-[#085394] text-white">
                                        ...
                                        <tbody>
                                            {usuarios
                                                ...
                                                .map((u: UsuarioDisponible) => (
                                                    <tr key={u.idUsuario} className="border-b hover:bg-blue-50">
